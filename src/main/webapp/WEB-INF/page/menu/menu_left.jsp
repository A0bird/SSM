<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*,com.ls.vo.Menu"%>
<%
...
<div>
	<script type="text/javascript">
		...
		for(Menu menu:list){
		%>
		d.add(<%=menu.getMenuId()%>,<%=menu.getPrentMenuId()%>,"<%=menu.getMenuName()%>","menu/menumain.do?menuId=<%=menu.getMenuId()%>","","rightframe");
		<%}}%>
		document.write(d);
	</script>
